...
RSpec.describe "Merchant Item Index Page" do
  it "can show all merchant items" do
    ...
    merchant_admin = User.create!(name: "Admin", address: "1230 East Street", city: "Boulder", state: "CO", zip: 98273, email: "admin@admin.com", password: "admin", password_confirmation: "admin", role: 3)
