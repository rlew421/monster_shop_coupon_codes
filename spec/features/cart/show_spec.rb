...
RSpec.describe 'Cart show' do
  describe 'When I have added items to my cart' do
    describe 'and visit my cart path' do
      ...
      it "when I enter in a coupon code, I see my discounted subtotals and discounted total" do
        ...
        expect(page).to have_content("Total: $244.00")
        expect(page).to have_content("Discounted Total: $241.80")
      end
    end
  end
