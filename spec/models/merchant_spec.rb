...
describe Merchant, type: :model do
  ...
  describe 'instance methods' do
    ...
    it "#order_creation_date" do
      ...
      expect(bike_shop.order_creation_date(order_1.id)).to eq(order_1.created_at)
      expect(ski_shop.order_creation_date(order_3.id)).to eq(order_3.created_at)
    end
  end
end
